...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(pagerControllerinMove:)]){
        [self.delegate pagerControllerinMove:self];
    }
}
...
- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset{
    printf("scrollViewWillEndDragging:\n");
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(pagerControllerStopMove:)]){
        [self.delegate pagerControllerStopMove:self];
    }
}
...
- (void)scrollViewDidEndZooming:(UIScrollView *)scrollView withView:(nullable UIView *)view atScale:(CGFloat)scale{
    printf("scrollViewDidEndZooming:\n");
}

- (void)scrollViewDidScrollToTop:(UIScrollView *)scrollView{
    printf("scrollViewDidScrollToTop:\n");
}

- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
    printf("scrollViewWillBeginDragging:\n");
    if (self.delegate && [self.delegate respondsToSelector:@selector(pagerControllerStartMove:)]){
        [self.delegate pagerControllerStartMove:self];
    }
