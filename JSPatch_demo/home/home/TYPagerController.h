...
//开始变化
- (void)pagerControllerStartMove:(TYPagerController *)pagerController;
- (void)pagerControllerinMove:(TYPagerController *)pagerController;
- (void)pagerControllerStopMove:(TYPagerController *)pagerController;
